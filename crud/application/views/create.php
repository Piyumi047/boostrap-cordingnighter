     	...
     	<div class="col-lg-6">
     		 <div class="form-group">
               <label for="inputEmail" class="col-lg-2 control-label">Customer_Name</label>
                  <div class="col-lg-10">
                      <?php echo form_input(['name'=>'customername','class'=>'form-control','placeholder'=>'Customer_Name','value'=>set_value('customername')]); ?>
                  </div>
             </div>
                  <div class="col-lg-6">
     	...
     	<div class="col-lg-6">
     		 <div class="form-group">
               <label for="inputEmail" class="col-lg-2 control-label">Order_Details</label>
                  <div class="col-lg-10">
                      <?php echo form_input(['name'=>'order','class'=>'form-control','placeholder'=>'Order_Details','value'=>set_value('order')]); ?>
                  </div>
             </div>
                  <div class="col-lg-6">
